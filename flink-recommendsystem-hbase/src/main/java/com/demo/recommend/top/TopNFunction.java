package com.demo.recommend.top;

import com.demo.recommend.domain.RankProductEntity;
...
public class TopNFunction extends
    ...
    @Override
    public void process(Context context, Iterable<TopProductEntity> iterable, Collector<RankProductEntity> collector) {
