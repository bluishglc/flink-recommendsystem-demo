package com.demo.recommend.scheduler;
...
import com.demo.recommend.domain.ProductPortraitEntity;
import com.demo.recommend.util.Constants;
...
public class ProductCoeff {
    ...
    public void getSingleProductCoeff(String id, List<String> others) throws Exception {
        ProductPortraitEntity product = singleProduct(id);
        for (String proId : others) {
            if (id.equals(proId))
                continue;
            ProductPortraitEntity entity = singleProduct(proId);
     ...
     * @throws IOException
     */
    private ProductPortraitEntity singleProduct(String proId) {
